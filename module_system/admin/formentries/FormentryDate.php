...
class FormentryDate extends FormentryBase implements FormentryPrintableInterface
{
     ...
     * @return string
     */
    public function getValueAsDateFormat(): string
    {
        $date = new Date($this->getStrValue());

//        return date('Y-m-dTH:i:sZ', $date->getTimeInOldStyle());
        return date('c', $date->getTimeInOldStyle());
    }
    ...
    public function jsonSerialize(): array
    {
        ...
        $fieldParams['value'] = $this->getValueAsDateFormat();
