...
$lang["commons_object_validator_number_field_greater_than"] = "'{0}' muss > '{1}' sein";
$lang["commons_object_validator_number_field_greaterequals_than"] = "'{0}' muss >= '{1}' sein";
$lang["commons_object_validator_number_field_less_than"] = "'{0}' muss < '{1}' sein";
$lang["commons_object_validator_number_field_lessequals_than"] = "'{0}' muss <= '{1}' sein";
$lang["commons_object_validator_number_fieldcompare_greater_than"] = "'{0}' muss > '{1}' sein";
$lang["commons_object_validator_number_fieldcompare_greaterequals_than"] = "'{0}' muss >= '{1}' sein";
...
$lang["commons_send_notification"] = "Benachrichtigung senden";
