...
final class TagModelActionTest extends ModelActionTestCase
{
    /**
     * @return Model
     * @throws Exception
    ...
    {
        $statusModelAction = new TagModelAction(
            $this->createPositiveFeatureDetector(),
     ...
     * @param Model $modelInAValidState
     */
    public function testDeniesAvailabilityIfModelIsInAValidStateButTagFeatureIsNotAvailable(Model $modelInAValidState): void
    {
        $statusModelAction = new TagModelAction(
            $this->createNegativeFeatureDetector(),
            $this->createDummyToolkit(),
            $this->createDummyLang()
        );

        $this->assertFalse($statusModelAction->supports($modelInAValidState, $this->createDummyContext()));
    }
